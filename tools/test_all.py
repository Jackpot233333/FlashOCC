...
def parse_args():
    ...
    parser.add_argument('--outputs_data', type=str)
        ...
        with torch.no_grad():
            ...
            if img.shape[0] > 6:
                ...
                onnx_input = {
                    ...
                    "ranks_feat": metas[1].int().contiguous().numpy(),
                    "ranks_bev": metas[2].int().contiguous().numpy(),
                    "n_points": np.array([metas[3]]).astype(np.int32)
                }
